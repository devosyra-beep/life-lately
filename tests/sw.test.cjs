/* v33 service-worker unit tests: an in-memory Cache adapter, no real installation. */
...
const current='life-lately-v33-wordmark-20260919';
const caches={open:async()=>cache,keys:async()=>['life-lately-v24-cofrinhos-20260919','life-lately-v25-landing-20260919','life-lately-v29-nav-20260919','life-lately-v30-nav-20260919','life-lately-v31-logo-20260919','life-lately-v32-navigation-20260919','unrelated-cache',current],delete:async k=>{deleted.push(k);return true;}};
...
(async()=>{
 ...
 assert(await request('/assets/landing/landing.css','same-origin'));assert(await request('/assets/landing/life-lately-sunset.jpg','same-origin'));ok('CSS e fotografia têm fallback offline');
