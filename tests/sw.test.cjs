/* Service-worker unit tests: an in-memory Cache adapter, no real installation. */
...
(async()=>{
 ...
 handlers.activate({waitUntil:p=>pending=p});await pending;assert.deepEqual(deleted,['life-lately-v24-cofrinhos-20260919','life-lately-v25-landing-20260919','life-lately-v29-nav-20260919','life-lately-v30-nav-20260919','life-lately-v31-logo-20260919','life-lately-v32-navigation-20260919','life-lately-v33-wordmark-20260919','life-lately-v34-strategic-20260919','life-lately-v36-cloud-access-20260919','life-lately-v37-three-access-options-20260919','life-lately-v38-google-label-center-20260920','life-lately-v39-clean-access-20260920','life-lately-v41-network-first-20260920']);assert.equal(claimed,1);ok('Só os caches antigos do Life Lately são removidos');
 ...
 const app=fs.readFileSync(path.join(dir,'app/index.html'),'utf8');assert(app.includes('src="../core.js?v=42"'));assert(app.includes('href="../manifest.webmanifest"'));assert(!app.includes('assets/landing/landing.css'));ok('HTML de login usa recursos versionados do app, sem misturar CSS da landing');
